...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'nim_forum.data';
      var REMOTE_PACKAGE_BASE = 'nim_forum.data';
          ...
          DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_nim_forum.data');

      };
      Module['addRunDependency']('datafile_nim_forum.data');
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 123360,
    DYNAMIC_BASE = 5366240,
    DYNAMICTOP_PTR = 123200;
...
var wasmBinaryFile = 'nim_forum.wasm';
